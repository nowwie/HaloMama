              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildTipItem(
                        "Self-Care Recharge: Quick 5-min Tips",
          ...
          child: Column(
            ...
            children: [
              ...
              const Align(
                ...
                child: Text(
                  "Hi Mama, I’m here if you want to talk 💕",
...
Widget _buildSelfCareCard(String title, String subtitle, String imagePath) {
  return Container(
    padding: const EdgeInsets.all(12),
    decoration: BoxDecoration(
